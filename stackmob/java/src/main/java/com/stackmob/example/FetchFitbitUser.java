  ...
  public ResponseToProcess execute(ProcessedAPIRequest request, SDKServiceProvider serviceProvider) {
      ...
      try {
          ...
          if (cred == null) {
              ...
              logger.debug("no existing creds");
          }
          ...
          String userInfoJson = agent.getUserInfoJsonSM(fitbitUser, new AccessToken(accessToken, accessTokenSecret), serviceProvider);
