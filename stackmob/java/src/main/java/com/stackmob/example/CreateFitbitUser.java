...
//      populate(context, request, response);
      ...
      try {
          ...
          LocalUserDetail user = new LocalUserDetail("12345678");
          APIResourceCredentials cred = new APIResourceCredentials(user.getUserId(), tempTokenReceived, tempTokenVerifier);
